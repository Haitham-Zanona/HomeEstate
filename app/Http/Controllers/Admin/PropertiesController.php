...
class PropertiesController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.properties.general.index', compact('properties', 'admin'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.properties.general.create', $data, compact('admin'));
    }
    ...
    public function getprice($property_id)
    {
        ...
        return view('dashboard.properties.prices.create', compact('admin'))->with('id', $property_id);
    ...
    public function savePropertyPrice(PropertyPriceValidation $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.properties', compact('admin'))->with(['error' => 'An error occurred']);
        }
    ...
    public function getPropertyFeature($property_id)
    {
        ...
        return view('dashboard.properties.features.create', compact('admin'))->with('id', $property_id);
    ...
    public function savePropertyFeature(PropertyFeatureRequest $request)
    {
        ...
        return redirect()->route('admin.properties', compact('admin'))->with(['success' => 'Updated successfully']);
    ...
    public function addImages($property_id)
    {
        ...
        return view('dashboard.properties.images.create', compact('admin'))->withId($property_id);
    ...
    public function savePropertyImagesDB(PropertyImagesRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.properties', compact('admin'))->with(['success' => 'successfully']);
