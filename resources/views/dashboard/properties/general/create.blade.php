                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="building_age" class="form-control"
                                                            placeholder="  " value="{{ old('building_age') }}"
                                                            name="building_age">
                                                        @error('building_age')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="parking" class="form-control"
                                                            placeholder="  " value="{{ old('parking') }}" name="parking">
                                                        @error('parking')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="cooling" class="form-control"
                                                            placeholder="  " value="{{ old('cooling') }}" name="cooling">
                                                        @error('cooling')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="heating" class="form-control"
                                                            placeholder="  " value="{{ old('heating') }}" name="heating">
                                                        @error('heating')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="sewer" class="form-control"
                                                            placeholder="  " value="{{ old('sewer') }}" name="sewer">
                                                        @error('sewer')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="water" class="form-control"
                                                            placeholder="  " value="{{ old('water') }}" name="water">
                                                        @error('water')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="exercise_room" class="form-control"
                                                            placeholder="  " value="{{ old('exercise_room') }}"
                                                            name="exercise_room">
                                                        @error('exercise_room')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="eventInput1"> Storage Room
                                                        </label>
                                                        <input type="text" id="torage_room" class="form-control"
                                                            placeholder="  " value="{{ old('torage_room') }}"
                                                            name="torage_room">
                                                        @error('torage_room')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
