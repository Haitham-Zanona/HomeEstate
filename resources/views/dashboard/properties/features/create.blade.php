        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Create<small>Features</small></h2>
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="area" class="form-control"
                                                            placeholder="  " value="{{ old('area') }}" name="area">
                                                        @error('area')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="rooms" class="form-control"
                                                            placeholder="  " value="{{ old('rooms') }}" name="rooms">
                                                        @error('rooms')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="bedrooms" class="form-control"
                                                            placeholder="  " value="{{ old('bedrooms') }}" name="bedrooms">
                                                        @error('bedrooms')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="bathrooms" class="form-control"
                                                            placeholder="  " value="{{ old('bathrooms') }}"
                                                            name="bathrooms">
                                                        @error('bathrooms')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="air_condition" value="1"
                                                                class="flat"> <span>Air Conditioning</span>
                                                        </label>
                                                        @error('air_condition')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="swimming_pool" value="1"
                                                                class="flat"> <span>Swimming Pool</span>
                                                        </label>
                                                    </div>
                                                    @error('swimming_pool')
                                                        <span class="text-danger">{{ $message }}</span>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="central_heating" value="1"
                                                                class="flat"> <span>Central Heating</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="laundry_room" value="1"
                                                                class="flat"> <span>Laundry Room</span>
                                                        </label>
                                                    </div>
                                                    @error('laundry_room')
                                                        <span class="text-danger">{{ $message }}</span>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" name="window_covering" value="1"
                                                                class="flat"> <span>Window Covering</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 offset-md-3">
                                                <button class="btn btn-primary" type="button"><a
                                                        href="{{ route('admin.properties.features', ['id' => $id]) }}"
