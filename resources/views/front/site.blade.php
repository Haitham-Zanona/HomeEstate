...
@section('content')
    ...
    <div class="featured-properties content-area-7">
        <div class="container-fluid">
            <div class="main-title">
                ...
                <p>Find the perfect home that suits your style, needs, and budget today.</p>
            </div>
            <div class="row slick-fullwidth wow fadeInUp delay-04s">
                @isset($properties)
                    @foreach ($properties as $property)
                        <div class="col-md-3 h-100 slick-slide-item">
                            <div class="m-0 h-100 property-box">
                                <div class="property-thumbnail">
                                    <a href="{{ route('property.details', $property->id) }}" class="property-img">
                                        ...
                                        <img src="{{ $property->images[0]->photo ?? '' }}" alt="property-box" class="img-fluid"
                                            style="height: 280px;">
                                    </a>
                                ...
                                <div class="detail">
                                    ...
                                    <div class="location">
                                        <a href="properties-details.html">
                                            <i
                                                class="flaticon-facebook-placeholder-for-locate-places-on-maps"></i>{{ $property->location }}
                                        </a>
                                    </div>
    ...
    <div class="services-3 content-area-20 bg-white">
        <div class="container">
            <div class="main-title">
                ...
                <p>Find your perfect home in just a click.</p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft delay-04s">
                    <div class="services-info-3">
                        ...
                        <p>Modern, clean apartments offering comfort, convenience, and a perfect living experience."</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInUp delay-04s">
                    <div class="services-info-3">
                        ...
                        <h5>Houses</h5>
                        <p>Spacious, modern houses designed for comfort, style, and your perfect living experience.</p>
                        <a href="services.html" class="read-more">Read more...</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInDown delay-04s">
                    <div class="services-info-3">
                        ...
                        <h5>Support 24/7</h5>
                        <p>Reliable, round-the-clock support available 24/7 to assist you anytime, day or night.</p>
                        <a href="services.html" class="read-more">Read more...</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInRight delay-04s">
                    <div class="services-info-3">
                        ...
                        <h5>Commercial</h5>
                        <p>Prime commercial properties designed for business success, offering flexibility and strategic
                            locations.</p>
                        <a href="services.html" class="read-more">Read more...</a>
                    </div>
                </div>
                <div class="col-lg-12 text-center">
                    <a data-animation="animated fadeInUp delay-10s" href="#" class="btn btn-lg btn-theme">More
                        Details</a>
                </div>
            </div>
        </div>
    ...
    <div class="recent-properties content-area-2">
        <div class="container">
            <div class="main-title">
                ...
                <p>Explore Our Latest Listings and Find Your Perfect Property Today</p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 wow fadeInLeft delay-04s">
                    <div class="property-box-8">
                        ...
                        <div class="detail">
                            <div class="heading">
                                ...
                                <div class="location">
                                    <a href="properties-details.html">
                                        <i class="flaticon-facebook-placeholder-for-locate-places-on-maps"></i>123 Kathal
                                        St. Tampa City,
                                    </a>
                                </div>
                            </div>
    ...
    <div class="most-popular-places content-area-3">
        <div class="container">
            <div class="main-title">
                ...
                <p>Explore the best locations for your dream home investment.</p>
            </div>
            <div class="container">
                <div class="row">
                    @isset($cities)
    ...
    <div class="agent content-area">
        <div class="container">
            <div class="main-title">
                ...
                <p>Meet our expert agents ready to assist you every step.</p>
            </div>
            <div class="row">
            ...
            <div class="slick-slider-area">
                <div class="row slick-carousel wow fadeInUp delay-04s"
                    ...
                    <div class="slick-slide-item wow">
                        <div class="testimonial-inner">
                            <div class="content-box">
                                <p>Working with this team was a pleasure! They helped me find the perfect apartment, paying
                                    attention to every detail and ensuring satisfaction.</p>
                            </div>
                    ...
                    <div class="slick-slide-item wow">
                        <div class="testimonial-inner">
                            <div class="content-box">
                                <p>I had a fantastic experience. They were responsive and guided me through every step. I
                                    found my dream home with ease.</p>
                            </div>
                            <div class="arrow-down"></div>
                            <div class="media user">
                                <a href="#">
                    ...
                    <div class="slick-slide-item">
                        <div class="testimonial-inner">
                            <div class="content-box">
                                <p>As a creative professional, I needed an inspiring space. The team understood my needs and
                                    found a place that exceeded expectations.</p>
                            </div>
                            <div class="arrow-down"></div>
                            <div class="media user">
                                <a href="#">
                    ...
                    <div class="slick-slide-item">
                        <div class="testimonial-inner">
                            <div class="content-box">
                                <p>From start to finish, the team provided exceptional service. They found me a home that
                                    checked all the boxes. Highly recommend!</p>
                            </div>
                            <div class="arrow-down"></div>
                            <div class="media user">
                                <a href="#">
    ...
    <div class="blog content-area-2">
        <div class="container">
            <div class="main-title">
                <h1>Latest Blog</h1>
                <p>Stay updated with the latest trends and insights in real estate.</p>
            </div>
            <div class="row">
                    ...
                    <div class="row blog-3">
                        ...
                        <div class="col-lg-7 col-md-12 col-pad">
                            <div class="detail clearfix">
                                ...
                                <p>Buying a home is a big decision that requires careful planning. Start by setting a budget
                                    and securing financing. Work with a trusted agent to find the perfect property for your
                                    needs.</span></p>
                    ...
                    <div class="row blog-3">
                        ...
                        <div class="col-lg-7 col-md-12 col-pad">
                            <div class="detail clearfix">
                                ...
                                <p>Selling your home requires preparation and strategy. Determine market value and make
                                    repairs. Partner with an agent to sell efficiently.</span></p>
                                <div class="blog-footer clearfix">
                                    <div class="float-left">
                                        <p class="date"><i class="flaticon-calendar"></i> 24 Sep, 2020</p>
                                    </div>
                        ...
                        <form action="#" method="GET" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-12">
                                    <div class="send-btn">
                                        <button type="submit" class="btn btn-color btn-md btn-message">Get it
                                            now</button>
                                    </div>
                                </div>
                            </div>
